...
const isElementInArray = (searchElement, inputArray) => {
    ...
    return inputArray                      //<--здесь можно было создать новые переменные и присвоить им значения вызываемых методов. Но лучше вызвать методы по цепочке. Вначале map проходим по всем элементам исходного массива, превращаем их в строки и заносим в новый массив, затем includes ищем нужные элементы в результирующем массиве
